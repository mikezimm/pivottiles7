...
import { IPeoplePickerEntity, IClientPeoplePickerQueryParameters, ISearchQuery, SearchResults, ISearchProperty, SortDirection } from '@pnp/sp/presets/all';
...
export class spservices implements ISPServices {
    ...
    public async searchUsers(searchString: string, searchFirstName: boolean): Promise<SearchResults> {
        ...
        try {
            ...
            let users = await sp.searchWithCaching(<ISearchQuery>{
                Querytext: _search,
                RowLimit: 500,
