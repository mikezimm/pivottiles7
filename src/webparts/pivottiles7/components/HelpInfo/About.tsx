 ...
 */
            ...
            thisPage = <div>
                ...
                <table className={styles.infoTable} style={{ width: '100%' }}>
                    ...
                    <tr><td>2020-12-01</td><td>{'1.2.2.4'}</td><td>Add quick-sort button</td></tr>
                    <tr><td>2020-12-01</td><td>{'1.2.2.3'}</td><td>Auto add Associated Groups to settings when opening property pane, complex group styles and options.</td></tr>
