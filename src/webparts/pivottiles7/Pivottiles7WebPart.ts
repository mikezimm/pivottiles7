...
import Pivottiles7 from './components/Pivottiles7';
import { IPivottiles7Props } from './components/IPivottiles7Props';
...
export default class Pivottiles7WebPart extends BaseClientSideWebPart<IPivottiles7WebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IPivottiles7Props> = React.createElement(
      Pivottiles7,
      {
